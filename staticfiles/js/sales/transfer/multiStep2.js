document.addEventListener("DOMContentLoaded", function () {
  ...
  function showStep(step) {
    ...
    indicators.forEach((ind, idx) => {
      ind.classList.toggle('bg-blue-800', idx < step);
  ...
  function showValidationMessage(message) {
    ...
    messageDiv.className = 'relative px-4 py-2 mt-4 text-red-700 bg-red-100 border border-red-400 rounded validation-message';
