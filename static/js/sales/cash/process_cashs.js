    ...
    try {
        ...
        if (result.success) {
            ...
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: result.message || 'Error al procesar la venta.', // Mostrar el mensaje específico del backend
                timer: 3000,
                timerProgressBar: true,
                customClass: {
                    confirmButton: 'bg-primary text-white'
        ...
        Swal.fire({
            ...
            text: 'No se pudo procesar la venta debido a un error de conexión.',
            timer: 3000,
            timerProgressBar: true,
            customClass: {
                confirmButton: 'bg-primary text-white'
