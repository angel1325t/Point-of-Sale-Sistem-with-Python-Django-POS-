...
from apps.ventas.views import income_expenses_data, top_products_data, sales_by_categories, chart_data,sale_pdf,sales_statistics
from apps.returns.views import returns_by_period, most_returned_products, return_reasons_data, return_pdf,return_statistics
...
urlpatterns = [
    ...
    path('ventas_estadisticas/', sales_statistics, name='ventas_estadisticas'),
    ...
    path('estadisticas-devoluciones/', return_statistics, name='return_statistics'),
    path('devoluciones_por_periodo/', returns_by_period, name='devoluciones_por_periodo'),
    path('productos_mas_devueltos/', most_returned_products, name='productos_mas_devueltos'),
    path('motivos_devolucion_data/', return_reasons_data, name='motivos_devolucion_data'),
