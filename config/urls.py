...
urlpatterns = [
    ...
    path('ingresos_egresos_data/', views.ingresos_egresos_data, name='ingresos_egresos_data'),
    path('top_productos_data/', views.top_productos_data, name='top_productos_data'),
    path('ventas_por_categoria_data/', views.ventas_por_categoria_data, name='ventas_por_categoria_data'),
